...
namespace GestionAlmacen.Controladores
{
    public class ControladorProveedores
    {
        ...
        /// <returns></returns>
        public bool AddProveedor(string cif, string nombre, string telefono)
        {
            ...
            using (MySqlConnection cnn = new MySqlConnection(connectionString))
            {
                try
                {
                    ...
                    comando.CommandText = "INSERT INTO Proveedores ( CIF, Nombre, Telefono) " +
                ...
                {
                    Console.WriteLine("Error al crear proveedor" + e.Message);
                }
            }
            return respuesta;
        }
        ...
        public DataSet cargarProveedor()
        {
            ...
            try
            {
                ...
                cnn.Open();
                MySqlDataAdapter dataAdapter = new MySqlDataAdapter("SELECT * FROM Proveedores", cnn);
            ...
            {
                Console.WriteLine("Error leyendo fichero proveedores " + e.Message);
            }
            return dataSet;
        }
        /// <summary>
        ...
        public bool eliminarProveedor(string cif)
        {
            bool respuesta = false;
            ...
            using (MySqlConnection cnn = new MySqlConnection(connectionString))
            {
                try
                {
                    ...
                    MySqlCommand comando = cnn.CreateCommand();
                    comando.CommandType = CommandType.Text;
                    comando.CommandText = "DELETE FROM Proveedores WHERE CIF = @cif";
                    comando.Parameters.AddWithValue("@cif", cif);
                    comando.Prepare();
                    MySqlDataAdapter adaptador = new MySqlDataAdapter();
                    adaptador.InsertCommand = comando;
                ...
                {
                    Console.WriteLine("Error al borrar en la tabla Proveedores" + e.Message);
                }
                return respuesta;
            }
        }
